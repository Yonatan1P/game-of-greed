...
def diff(game_play_func, path="", sample=""):
    """runs a given game play function and compares output with contents of given simulation text
    ...
    actual_text = "" # actual generated from game text
    ...
    def mock_input(*args):
        ...
        actual_text += "".join(args) + response + "\n"
    ...
    return _find_differences(actual_text, expected_lines)
